                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="about__content">
                            ...
                            <p class="about__content--desc mb-25">We strive to streamline the sourcing process for high-quality automotive parts, making it seamless and stress-free. Every engine and transmission in our inventory is thoroughly inspected and verified to ensure maximum reliability and longevity on the road.</p>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <div class="team__items text-center">
                                ...
                                <div class="team__content">
                                    ...
                                    <span class="team__content--subtitle">Warehouse Manager</span>
                                    <ul class="team__social d-flex justify-content-center align-items-center">
                                        <li class="team__social--list">
                                            <a class="team__social--icon" target="_blank" href="https://www.facebook.com">
                                                <svg  xmlns="http://www.w3.org/2000/svg" width="7.667" height="15.524" viewBox="0 0 7.667 16.524">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <div class="team__items text-center">
                                ...
                                <div class="team__content">
                                    ...
                                    <span class="team__content--subtitle">Inventory Specialist</span>
                                    <ul class="team__social d-flex justify-content-center align-items-center">
                                        <li class="team__social--list">
                                            <a class="team__social--icon" target="_blank" href="https://www.facebook.com">
                                                <svg  xmlns="http://www.w3.org/2000/svg" width="7.667" height="15.524" viewBox="0 0 7.667 16.524">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <div class="team__items text-center">
                                ...
                                <div class="team__content">
                                    ...
                                    <span class="team__content--subtitle">Technical Manager</span>
                                    <ul class="team__social d-flex justify-content-center align-items-center">
                                        <li class="team__social--list">
                                            <a class="team__social--icon" target="_blank" href="https://www.facebook.com">
                                                <svg  xmlns="http://www.w3.org/2000/svg" width="7.667" height="15.524" viewBox="0 0 7.667 16.524">
                        ...
                        <div class="swiper-wrapper">
                             <div class="swiper-slide">
                                 <div class="testimonial__items--content">
                                     <p class="testimonial__items--desc">"Finding a high-quality used engine for my truck was incredibly easy here. The customer support team verified my VIN, and the shipping was fast and free. Highly recommended!"</p>
                                     ...
                                     <span class="testimonial__items--subtitle">Sarah Jenkins</span>
                                 </div>
                             </div>
                            <div class="swiper-slide">
                                <div class="testimonial__items--content">
                                    <p class="testimonial__items--desc">"Exceptional service and extremely reliable parts! The replacement transmission I ordered fits perfectly and operates flawlessly. I will definitely be a returning customer."</p>
                                    <ul class="rating testimonial__rating d-flex justify-content-center">
                                         <li class="rating__list">
                                             <span class="rating__icon">
                                                 <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span class="testimonial__items--subtitle">Mark Thompson</span>
                                </div>
                            </div>
                        </div>
                    </div>
